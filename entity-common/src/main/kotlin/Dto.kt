...
data class Order(val id: String, val orderType: OrderType, val symbol: String, var fills: MutableList<Match> = mutableListOf(), var status: State = State.OPEN, var qtyOnMarket: Int, var qtyFilled: Int = 0, val price: Int, val traderId: String)
